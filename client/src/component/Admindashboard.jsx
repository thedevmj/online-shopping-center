  ...
  return (
    <div className="min-h-screen bg-slate-950">
      ...
      <div className="relative z-10">
        ...
        <div className="border-b border-lime-500/30 backdrop-blur-xl bg-slate-900/50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <h1 className="text-3xl font-bold bg-linear-to-r from-lime-400 to-blue-400 bg-clip-text text-transparent">
              Admin Dashboard
            </h1>
            <p className="text-lime-300/60 mt-2">Manage your ShopHub platform</p>
          </div>
        </div>

       
        <div className="border-b border-lime-500/20 backdrop-blur-xl bg-slate-900/30 sticky top-0 z-40">
                ...
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-2 rounded-lg font-medium transition-all duration-200 whitespace-nowrap ${
                    activeTab === id
                      ...
                      : 'bg-slate-700/50 text-slate-300 border border-lime-500/20 hover:bg-slate-600/50'
                  }`}
                >
            ...
            fallback={
              <div className="flex items-center justify-center h-96">
                <div className="text-center">
                  <div className="inline-flex items-center justify-center h-12 w-12 rounded-full bg-lime-500/10 mb-4">
                    <div className="h-8 w-8 border-t-2 border-lime-400 rounded-full animate-spin" />
                  </div>
                  <p className="text-lime-300">Loading...</p>
                </div>
              </div>
            }
          >
